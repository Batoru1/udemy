...
// the body element is clicked. Do not select the h1 element again! -use header
...
// //2 it worked, because thecall-back(eventlistener) function had access to all the variabnles inside header, necause of closure
///jonas exmpl
// (function () {
//   const header = document.querySelector('h1');
//   header.style.color = 'red';
